      ...
      <header class="shadow-sm">
          ...
          <div class="container">
            ...
            <div class="tns-carousel tns-controls-static d-none d-md-block">
              <div class="tns-carousel-inner" data-carousel-options="{&quot;mode&quot;: &quot;gallery&quot;, &quot;nav&quot;: false}">
                <div class="topbar-text">Free shipping for order over PKR 2000</div>
        ...
        <div class="navbar-sticky bg-light">
          <div class="navbar navbar-expand-lg navbar-light">
            <div class="container"><a class="navbar-brand d-none d-sm-block flex-shrink-0" href="{{url('/')}}"><img src="{{asset('expert-template/img/logo-dark.png')}}" width="142" alt="Cartzilla"></a><a class="navbar-brand d-sm-none flex-shrink-0 me-2" href="index.html"><img src="{{asset('expert-template/img/logo-icon.png')}}" width="74" alt="Cartzilla"></a>
        ...
        <div class="container">
          ...
          <div class="row pb-2">
            <div class="col-md-6 text-center text-md-start mb-4">
              <div class="text-nowrap mb-4"><a class="d-inline-block align-middle mt-n1 me-3" href="#"><img class="d-block" src="{{asset('expert-template/img/footer-logo-light.png')}}" width="117" alt="Cartzilla"></a>
              </div>
