...
<div class="col-12 ">
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{url('admin/expire_order')}}" class="btn btn-primary">Make Old Order Expire</a>
        </div>
        <table id="datatables-buttons" class="table table-striped">
            ...
            <tbody>
                ...
                <tr> 
                    ...
                    <td>
                        @if($order->status != 'Expired')
                        <a href="{{route('admin.order.deliver',$order->id)}}"><button class="btn btn-primary">Deliver</button></a>
                        @endif
                    </td>
                    <td>
